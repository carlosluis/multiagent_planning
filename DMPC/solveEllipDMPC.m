function [p,v,a,success] = solveEllipDMPC(po,pf,vo,ao,n,h,l,K,rmin,pmin,pmax,alim,A,A_initp,Delta,Q1,S1,E1,E2)
...
for k = 1: k_hor
    violation = CheckCollEllipDMPC(prev_p(:,k),l,n,k,E1,rmin);
    if (violation)
        [Ainr, binr] = CollConstrEllipDMPC(prev_p(:,k),po,vo,n,k,l,rmin,A,A_initp,E1,E2);
